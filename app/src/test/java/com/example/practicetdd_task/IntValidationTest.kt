...
class IntValidationTest {
    ...
    fun test_positive_success() {
        ...
        list.forEach { number ->
            Assert.assertEquals(true, newIntPositiveValidation.isValid(number = number))
            Assert.assertEquals(false, newIntNegativeValidation.isValid(number = number))
        }
    }
    ...
    fun test_positive_not_success() {
        ...
        list.forEach { number ->
            Assert.assertEquals(false, newIntPositiveValidation.isValid(number = number))
            Assert.assertEquals(true, newIntNegativeValidation.isValid(number = number))
        }
    }
    ...
    fun test_odd_success() {
        ...
        list.forEach { number ->
            Assert.assertEquals(true, newIntOddValidation.isValid(number = number))
        }
    }
    ...
    fun test_odd_not_success() {
        ...
        list.forEach { number ->
            Assert.assertEquals(false, newIntOddValidation.isValid(number = number))
        }
    }
    ...
    fun test_odd_and_positive_success() {
        ...
        list.forEach { number ->
            Assert.assertEquals(true, validation.isValid(number = number))
        }
    }
    ...
    fun test_odd_and_positive_not_success() {
        ...
        list.forEach { number ->
            Assert.assertEquals(false, validation.isValid(number = number))
        }
    }
